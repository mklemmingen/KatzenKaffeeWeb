    ...
    <div>
      ...
      <div id={"sustainable-diet"} className="section">
        <div className="section-content">
          ...
          <p>
            Eine nachhaltige Ernährung für Katzen beginnt mit der Auswahl von
            Futter, das umweltfreundlich produziert wird. Achten Sie auf
            Bio-Zutaten und vermeiden Sie Produkte mit unnötigen Zusatzstoffen.
            Einige Marken bieten sogar Insektenprotein als nachhaltige
            Alternative zu herkömmlichem Fleisch an. Denken Sie auch daran,
            lokale Produkte zu bevorzugen, um den CO2-Fußabdruck zu reduzieren.
          </p>
        </div>
      </div>
      <div id={"cat-litter"} className="section">
        <div className="section-content">
          ...
          <p>
            ...
            Optionen wie Holzpellets, Maiskörner oder recyceltes Papier
            zurückgreifen.
          </p>
          <p>
      ...
      <div id={"bird-protection"} className="section">
        <div className="section-content">
          ...
          <p>
            Katzen sind von Natur aus Jäger. Ihr Jagdinstinkt ist tief
            verwurzelt und sie können ihn nicht einfach abstellen. Leider führt
            dies dazu, dass sie viele Vögel fangen und töten. Studien zeigen,
            dass Katzen jedes Jahr <strong>1,3–4 Milliarden Vögel</strong> und{" "}
            <strong>6,3–22,3 Milliarden Säugetiere</strong> allein in den USA
            töten.
          </p>
          <p>
            Hauskatzen (Felis catus) sind weltweit verbreitet und gelten als
            Raubtiere. Dabei gehören sie, da Sie an den meisten Orten nicht von
            Natur aus schon da waren, zu den{" "}
            <strong>100 schlimmsten invasiven Arten der Welt</strong>.
            Freilaufende Katzen haben so zum Beispiel bereits zum Aussterben von{" "}
            <strong>33 Vogel-, Säugetier- und Reptilienarten</strong> auf Inseln
            beigetragen. Auch auf dem Festland können sie die Populationen von
            Vögeln und Säugetieren stark verringern.
          </p>
          <p>
            In Deutschland gibt es Gesetze und Initiativen, um die Anzahl der
            streunenden Katzen zu kontrollieren. Eine wichtige Maßnahme ist die{" "}
            <strong>Kastrationspflicht</strong>. Das bedeutet, dass Katzen, die
            draußen herumlaufen, kastriert werden müssen, damit sie sich nicht
            weiter vermehren. Diese Regelung gibt es in vielen Städten und
            Gemeinden.
          </p>
          <p>
            Außerdem gibt es Projekte wie{" "}
            <strong>Catch-Neuter-Return (CNR)</strong>. Dabei werden streunende
            Katzen eingefangen, kastriert und dann wieder freigelassen. So wird
            verhindert, dass sie sich weiter vermehren und die Zahl der Streuner
            wächst.
          </p>
          <h3>Tipps für ein nachhaltiges Miteinander</h3>
          <ul>
            <li>
              Bringen Sie Ihrer Katze ein Glöckchen am Halsband an, um Vögel zu
              warnen.
            </li>
            <li>
              Lassen Sie Ihre Katze in einem gesicherten Außenbereich oder an
              der Leine nach draußen.
            </li>
            <li>
              Das Adoptieren von ehamaligern Streunern in Tierheimen sorgt
              dafür, dass noch mehr Streuner dort aufgenommen werden können
            </li>
          </ul>
          <h3>Wohnungskatze vs. Freigängerkatze</h3>
          <p>
            Es gibt einen großen Unterschied zwischen Wohnungskatzen und
            Freigängerkatzen. Wohnungskatzen bleiben immer drinnen und haben
            weniger Möglichkeiten, Vögel und andere Tiere zu jagen. Sie sind
            sicherer vor Gefahren wie Autos und anderen Tieren, aber sie
            brauchen viel Beschäftigung und Spielzeug, um glücklich und gesund
            zu bleiben.
          </p>
          <p>
            Freigängerkatzen dürfen nach draußen und können ihre natürlichen
            Instinkte ausleben. Das bedeutet aber auch, dass sie Vögel und
            andere kleine Tiere jagen. Außerdem sind sie draußen vielen Gefahren
            ausgesetzt. Es ist wichtig, dass Katzenbesitzer die Vor- und
            Nachteile beider Haltungsformen abwägen und Maßnahmen ergreifen, um
        ...
        <div id="mental-health" className="section">
          <div className="section-content">
            ...
            <p>
              Katzen lieben Abwechslung und Beschäftigung. Ein Kratzbaum und
              interaktive Spielzeuge können helfen, Ihre Katze geistig fit und
              glücklich zu halten. <br />
              Regelmäßige Spielzeiten sind wichtig. Sie fördern die Bindung
              zwischen Ihnen und Ihrer Katze und sorgen für körperliche und
              geistige Auslastung.
            </p>
            <p>
              Rückzugsorte bieten Ihrer Katze Sicherheit und Geborgenheit. Diese
              Plätze sind wichtig für ihre mentale Gesundheit und ermöglichen
              ihr, sich zu entspannen. <br />
              Nachhaltige Spielzeuge aus recycelten Materialien oder
              DIY-Projekte sind eine tolle Möglichkeit, die Umwelt zu schonen
              und Ihre Katze zu unterhalten.
            </p>
            <MoodBoard
              imageUrls={[
        ...
        <div id="user-experiences">
          {Array.isArray(experiences) &&
            experiences.map((experience, index) => (
              <textarea key={index} value={experience} readOnly />
            ))}
        </div>
      </div>
    </div>
